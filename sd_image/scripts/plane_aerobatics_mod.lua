...
function horizontal_rectangle(total_length, total_width, r, bank_angle)
   ...
   gcs:send_text(6, string.format("Horizontal Rectangle: length:%f, width:%f, r:%f, bank_angle:%f",
      total_length, total_width, r, bank_angle))
...
gcs:send_text(0, string.format("Loaded plane_aerobatics_mod.lua"))
return update()
